...
> MUY IMPORTANTE: En el segundo paso hay que marcar para instalar la opción de JAVA_HOME para que podamos ejecutar todos los comandos de JAVA desde el terminal:
